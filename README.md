...
The backend folder consists of app.py which is a flask code, used as backend code for the project.
Run App.js and app.py simultaneously, by npm.start command in terminal of App.js and python run app.py in terminal of app.py (if you're using VS code).
